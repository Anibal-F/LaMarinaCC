...
def get_table_id_from_status(status_name: str) -> str:
    ...
    status_to_table = {
        ...
        'pérdida total y pago de daños': 'tableperdidapago',
        'perdida total y pago de danos': 'tableperdidapago',
...
async def extract_ordenes_from_status_tab(
    ...
    try:
        ...
        # SIEMPRE usar el nombre del tab como estatus (ignorar columna de tabla)
        # Esto garantiza consistencia: Asignados, Tránsito, Piso, Terminadas, 
        # Entregadas, Pérdida Total y Pago De Daños, Histórico, etc.
        for orden in ordenes:
            orden['estatus'] = status_name  # Usar SIEMPRE el nombre del tab
