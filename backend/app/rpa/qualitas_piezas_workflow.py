    ...
    async def _run_internal(
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                # El extractor navegará directamente a Bandeja Qualitas
                # No necesitamos navegar aquí, solo verificar que estamos logueados
                self.log("  Listo para extracción de piezas")
